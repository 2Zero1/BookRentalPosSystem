...
//        Book book = new Book(1,1,"드래곤라자",Jenre.FANTASY,500);
//        given(bookService.registerBook(book)).willReturn(true);
//
//        bookController.registerBook(book);
//        assertThat(outContent.toString()).isEqualTo("책 "+book.getName()+" 이 등록되었습니다.\n");
//    }
//}
